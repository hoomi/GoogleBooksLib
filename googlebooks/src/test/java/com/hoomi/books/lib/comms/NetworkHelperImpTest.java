...
import com.hoomi.books.lib.Constants;
...
public class NetworkHelperImpTest {
    ...
    @Test
    public void testGetVolumeDetails_Mock() throws Exception {
        final boolean[] booleanArray = {false};
        String volumeId = "9e9Kn9N8yP0C";
        MockResponse mockResponse = generateMockResponse(null, RESPONSE_VOLUME_DETAILS_BODY);
        ...
        networkHelperImp.volumeDetailsFromId(volumeId, new ResponseListener<VolumeDetails>() {
            ...
            @Override
            public void onError(ErrorModel errorModel) {
                assertFalse("This error should not have happened", true);
                countDownLatch.countDown();
    ...
    @Test
    public void testGetVolumeDetails_Actual() throws Exception {
        final boolean[] booleanArray = {false};
        String volumeId = "9e9Kn9N8yP0C";
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        networkHelperImp.volumeDetailsFromId(volumeId, new ResponseListener<VolumeDetails>() {
